...
smileConversion:	true,
			...
			allButtons: {
				...
				custom_quote : {
					...
					//subInsert: true,
					transform : { 
						'<blockquote><div id="quote2"><div class="head">{AUTHOR} rakstīja:</div><div class="quote">{SELTEXT}</div></div></blockquote>':'[quote={AUTHOR}]{SELTEXT}[/quote]'
					}
				},
				code : {
					title: CURLANG.code,
...
var nbhtml = $bel.html();
		...
		buildToolbar: function() {
			...
			var $bbsw = $(document.createElement('div')).addClass("wysibb-toolbar-container modeSwitch").html('<div class="wysibb-toolbar-btn mswitch" unselectable="on"></div>').appendTo(this.$toolbar);
